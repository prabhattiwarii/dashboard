...
import {billIcon,budgetIcon,gearIcon,homeIcon,planIcon,reportIcon,userIcon,walletIcon,wealthIcon} from "../helpers/Icon"
export const navigationLinks = [
    { id: 1, title: 'Home', icon:homeIcon},
    { id: 2, title: 'Budget', icon:budgetIcon},
    { id: 3, title: 'Transactions', icon:planIcon },
    { id: 4, title: 'Subscriptions', icon:walletIcon},
